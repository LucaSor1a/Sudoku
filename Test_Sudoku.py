from Sudoku import Sudoku, check_reps, overwrite, is_over, write, check, position_originals
import unittest
...
class TestSudoku(unittest.TestCase):
    ...
    def test_position_originals(self):
        self.assertEqual(sudoku.position_originals(table), ["00","01","04","10","13","14","15","21","22","27","30","34","38","40","43","45","48","50","54","58","61","66","67","73","74","75","78","84","87","88"])
    ...
    def test_written(self):
        ...
        self.assertEqual(table, ["534x7xxxx", "6xx195xxx", "x98xxxx6x", "8xxx6xxx3", "4xx8x3xx1", "7xxx2xxx6", "x6xxxx28x", "xxx419xx5", "xxxx8xx79"])
    ...
    def test_game_not_over(self):
        table = ["533175384", "612195537", "298376369", "882668363", "481863981", "717328356", "169836281", "916419925", "816288179"]
        over = sudoku.is_over(table)
